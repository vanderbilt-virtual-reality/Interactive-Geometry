...
public class OVRGrabber : MonoBehaviour
{
    ...
    // Made it virtual so I could override what call is made 
    protected virtual void OnUpdatedAnchors()
    {
        ...
        {
            // Should this instead just be an if-else?
            // As in if trigger was hand trigger, call:
            MoveGrabbedObject(destPos, destRot);
            // Else if index trigger, call
            // Custom method to adjust gameobject shape
        }
        m_lastPos = transform.position;
        m_lastRot = transform.rotation;
    ...
    public void OffhandGrabbed(OVRGrabbable closestGrabbable)
    {
